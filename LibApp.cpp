...
namespace sdds {
	...
	int LibApp::search(int version) {
		...
		* verson
		* 0=all
		* 1=Search Checkout Items Search only those publications which are on loan by library members
		* 2=Search Available Items Search only those publications which are not on loan
		* 
		* 
		*/
